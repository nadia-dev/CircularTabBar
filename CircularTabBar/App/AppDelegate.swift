...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let thirdCoord = AnyTabCoordinator(BaseTabCoordinator(color: .green))
        let fourthCoord = AnyTabCoordinator(BaseTabCoordinator(color: .yellow))
        
        self.appCoordinator = AppCoordinator(tabBarController: tabBarController!,
                                             tabs: [firstCoord, secondCoord, thirdCoord, fourthCoord])
